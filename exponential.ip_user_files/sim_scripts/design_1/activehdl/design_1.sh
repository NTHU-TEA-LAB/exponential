...
#
# Script generated by Vivado on Sun Feb 01 16:00:39 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/guan/Desktop/pynq_project/exponential/exponential.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
